...
test-osarch-specific:
	...
	# @go test -tags "libsqlite3 linux" -v -p 1 -skip 'Example' ./szengineserver
	@go test -tags "libsqlite3 linux" -json -v -p 1 -skip 'Example' ./szengineserver 2>&1 | tee /tmp/gotest.log | gotestfmt
