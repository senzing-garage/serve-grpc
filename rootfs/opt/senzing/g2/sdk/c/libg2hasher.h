...
extern "C"
{
   ...
   */
  _DLEXPORT int G2Hasher_init(const char *moduleName, const char *iniParams, const int verboseLogging);
  _DLEXPORT int G2Hasher_initWithConfig(const char *moduleName, const char *iniParams, const char *configJson, const int verboseLogging);
